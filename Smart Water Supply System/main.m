...
%set of states 
G.X = {'x1','x2','x3','x4','x5','x6','x7','x8','x9','x10','x11','x12','x13','x14','x15','x16','x17','x18','x19','x20'};
...
W_x13 = unique([W7,W8,W9,W8_1]);

W_x14 = unique([W41,W51,W61,W51_1]);

W_x15 = unique([W1,W2,W3,W2_1]);

W_x16 = unique([W42,W52,W62,W52_1]);

W_x17 = unique([W9,W8_1]);

W_x18 = unique([W61,W51_1]);

W_x19 = unique([W2_1,W3]);

W_x20 = unique([W62,W52_1]);

%output function
G.h = containers.Map({'x1','x2','x3','x4','x5','x6','x7','x8','x9','x10','x11','x12','x13','x14','x15','x16','x17','x18','x19','x20'}, ...
    {W_x1,W_x2,W_x3,W_x4,W_x5,W_x6,W_x7,W_x8,W_x9,W_x10,W_x11,W_x12,W_x13,W_x14,W_x15,W_x16,W_x17,W_x18,W_x19,W_x20});
...
G.B = {'x1', 'x2'; 'x1', 'x4'; 'x1', 'x5'; 
    ...
    'x8', 'x5'; 'x8', 'x7'; 'x8', 'x12';
    'x9', 'x10'; 'x9', 'x12';
    'x10', 'x9'; 'x10', 'x11'; 'x10', 'x18';
    'x11', 'x10'; 'x11', 'x12'; 'x11', 'x19';
    'x12', 'x9'; 'x12', 'x11'; 
    'x13', 'x9'; 'x13', 'x14'; 'x13', 'x16';
    'x14', 'x10'; 'x14', 'x13'; 'x14', 'x15'; 
    'x15', 'x11'; 'x15', 'x14'; 'x15', 'x16';
    'x16', 'x12'; 'x16', 'x13'; 'x16', 'x15';
    'x17', 'x9'; 'x17', 'x18'; 'x17', 'x20';
    'x18', 'x17'; 'x18', 'x19';
    'x19', 'x18'; 'x19', 'x20';
    'x20', 'x12'; 'x20', 'x17'; 'x20', 'x19';};
